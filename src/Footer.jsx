          ...
          <div class="container">
            ...
            <div class="row">
              <div class="footer-social-btn col-md-4 col-sm-3">
                ...
                <a target="_blank" href="https://www.instagram.com/_ilymun/" class="instagram-btn"><i class="fa fa-instagram"></i></a>
                <a target="_blank" href="https://www.youtube.com/channel/UCFmcIYRifCNmHt9sjoWUDsA" class="youtube-btn"><i class="fa fa-youtube-play"></i></a>
              </div>
              <div class="copyrights col-md-8 col-sm-9">
                <span style={{float: 'right'}}>&copy; <a href="/">ILYMUN</a> 2017, All Rights Reserved, Developed by <a href="http://pablogamito.com">Pablo Gamito</a></span>
              </div>
            </div>
          </div>
        </div>
