...
// import './wp-content/themes/ilymun-wp-theme/open-iconic/font/css/open-iconic-bootstrap.css';
...
// import './wp-content/themes/ilymun-wp-theme/css/font-awesome.min.css';
...
// import './wp-content/themes/ilymun-wp-theme/css/owl.carousel.css';
                          ...
                          <div class="row">
                              <div class="media-content col-md-5 col-sm-5"> {/* TODO ADD BACK: appear bounce-up*/}
                                  <div class="double-frame">
                                      <img class="lazy" data-original="./wp-content/themes/ilymun-wp-theme/images/about.jpg" />
                                  </div>
                              </div>
            ...
            <div class="container">
              ...
              <div class="section-content">
                <div class="row">
                  <div class="media-content col-md-5 col-sm-5"> {/* TODO ADD BACK: appear bounce-up*/}
                    <div class="double-frame">
                      <img class="lazy" data-original={require('./images/about.jpg')} />
                    </div>
                  </div>
                  <div class="content-box col-md-7 col-sm-7"> {/* TODO ADD BACK: appear bounce-up*/}
                    <div class="hex content-icon-hex pull-left">
